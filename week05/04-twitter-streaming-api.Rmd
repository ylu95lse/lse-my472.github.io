...
```{r}
authentication <- list(consumer_key = "3xZNBwBTaGqnIinjGuFYmfpQw",
                 consumer_secret = "D3pkqMv4fOd8ueJvHqbmgtxX5WqxYepCAxPcjY57vGOD4Cv7SI",
                 access_token = "893813325858881536-MTGjJSayvZ8OC93q5zOLbj3cSCXW4Gy",
                 access_token_secret = "TVbwiNVKctdCpwTEgBusLcimQGCxPDWUHe0nSpU14NJ4s")
```
...
=======
stream_tweets(q = -125, 26, -65, 49, timeout = 30, file_name='geotweets2.json')
#stream_tweets(q = lookup_coords("usa"), timeout = 30, file_name='__________________')

geo_tweets <- tryCatch({parse_stream('test_json')},
>>>>>>> Stashed changes
                       error = function(e)
                           {print(paste("Retrying with alternative function after initial error when parsing file",
                                        '__________________'));
