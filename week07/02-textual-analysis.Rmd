...
This corpus consists of three documents and two docvars:# docvas这里是什么意思？下面2 docvas是怎么来的？
...
We can now apply dictionary methods to these data. For this we first create a dictionary object from a simple named list. Note that this list could also e.g. contain two character vectors for words associated with positive and negative sentiments.# 还是不懂positive and negative在这里的意思
