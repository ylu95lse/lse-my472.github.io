...
rD <- rsDriver(browser=c("firefox"), port = 1491L)
driver <- rD[["client"]]
...
<<<<<<< Updated upstream
accept_button <- driver$___________(using = "xpath", 
=======
...
get_results_by_const <- function(const_name, sec = 4){
  ...
  search_field <- findElement(using = 'class name', value = 'ge-lookup__input')
  ...
  party_class <- results_html %>% 
    html_nodes(xpath = "xpath = "//tr/td[1]/span") %>%
    html_attr("class")
    party <- stri_replace_first_regexsub(".+-", "", party_class)
